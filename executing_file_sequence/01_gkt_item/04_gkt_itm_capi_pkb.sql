create or replace package body gkt_itm_capi is
/*
Description : This capi package(body) will hold all of the trigger function which are associated with the table gkt_item.
...
procedure gkt_itm001_ins(p_id out number) is 
/*
Description : This procedure will set the id value for the gkt_item table when an insert event is occured on that table.
...
end gkt_itm_capi; --End of packagae body
